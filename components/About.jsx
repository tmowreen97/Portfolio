...
function About(){
  return(
    <div className="w-full h-full justify-center items-center text-center bg-cover bg-center custom-img bg-fixed ">
      <div className="mx-auto w-full h-full justify-center items-center max-w-[71%]">
        <div className="items-center justify-center">
        <div className="text-left items-center justify-center pt-[15%] z-[90] ">
          <div className=''>
            <h1 className="text-7xl">Who am I?</h1>
          </div>
        <div className=" pl-5 py-10 z-[99] tracking-wider">
