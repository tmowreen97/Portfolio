      ...
      <div className="max-w-[1240px] w-full h-full flex justify-center items-center mx-auto">
        <div className="flex items-center m-20">
          <div className="text-left mx-15 items-center max-w-[70%] z-[99]">
            ...
            <div className=" pl-5 max-w-[78%] z-[99]">
              ...
              <div className="flex items-center justify-between p-5 z-[99]">
                <div className="rounded-full shadow-xl text-[#696969] bg-white/70 shadow-gray-400 p-6 mx-5 mt-10 hover:bg-slate-600/50 hover:text-[#F9FBFD] cursor-pointer">
                  <AiFillLinkedin/>
                </div>
                <div className="rounded-full shadow-xl text-[#696969] bg-white/70 shadow-gray-400 p-6 mx-5 mt-10 hover:bg-slate-600/50 hover:text-[#F9FBFD] cursor-pointer">
                  <AiFillGithub/>
