          ...
          <div className="text-left mx-15 items-center max-w-[70%] z-[90] tracking-wider">
            ...
            <div className=" pl-5 max-w-[78%] z-[99] tracking-wider">
              ...
              <div className="flex items-center justify-between p-5 z-[99]">
                <div className="rounded-full shadow-xl text-[#696969] bg-white/70 shadow-gray-600/90 p-6 mx-5 mt-10 hover:bg-slate-600/50 hover:text-[#F9FBFD] hover:scale-[1.35] ease-in-out duration-200 cursor-pointer">
                  <AiFillLinkedin/>
                </div>
                <div className="rounded-full shadow-xl text-[#696969] bg-white/70 shadow-gray-600/90 p-6 mx-5 mt-10 hover:bg-slate-600/50 hover:text-[#F9FBFD] hover:scale-[1.35] ease-in-out duration-200 cursor-pointer">
                  <AiFillGithub/>
