  ...
  return(
    ...
    <div className="hover:bg-slate-500/30 bg-[#ECE4CC]/20 shadow-xl md:flex items-center justify-evenly hover:scale-[1.1] rounded-xl p-2 ease-in-out duration-200">
      <div className="pr-5 group ">
        {/* <motion.div whileHover={[{ scale: 1.25 }, {rotate:-3}]} onMouseEnter={()=>setShowGif(true)} onMouseLeave={()=>setShowGif(false)} className="z-99 rounded-xl overflow-hidden opacity-100"> */}
        <motion.div whileHover={[{ scale: 1.25 }, {rotate:-3}]} onClick={()=> setShowGif(!showGif)} className="z-99 rounded-xl overflow-hidden opacity-100 hover:cursor-pointer">          
